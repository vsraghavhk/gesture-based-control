...
The final report for this project which explains the prohject in detail, is available [here](https://github.com/vsraghavhk/gesture-based-control/find/master). 
